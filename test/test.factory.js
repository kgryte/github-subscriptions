...
tape( 'function returns a function which returns an error to a provided callback if an error is encountered when fetching watched repositories', function test( t ) {
	var factory;
	var opts;
	var get;
...
tape( 'function returns a function which supports providing only a `token` option (get an authenticated user\'s subscriptions)', function test( t ) {
	var expected;
	var factory;
	var opts;
	var get;
...
tape( 'function returns a function which supports providing both `token` and `username` options to get who another user\'s subscriptions (increased rate limits)', function test( t ) {
	var expected;
	var factory;
	var opts;
	var get;
